...
<h2 class="page-header"><?php echo $job->title; ?> <small> in <?php echo $job->city; ?>, <?php echo $job->state; ?></small>
	<span class="pull-right">
		<a href="index.php?r=job/edit&id=<?php echo $job->id; ?>" class="btn btn-info">Edit Job Details</a>
...
<ul class="list-group">
		...
		<?php if(!empty($job->requirements)) : ?>
			<li class="list-group-item"><strong>Qualification(s): </strong><?php echo $job->requirements; ?></li>
		<?php endif ?>
...
<a href="mailto:<?php echo $job->contact_email; ?> Subject=Job Application" class="btn btn-primary btn-lg">Contact Employer</a>
